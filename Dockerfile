...
RUN /root/anaconda3/bin/pip install easydict opencv-contrib-python==3.4.2.17 Cython h5py pandas requests bs4 matplotlib lxml -U pillow keras==2.2.5 tensorflow==1.14.0 -i https://pypi.doubanio.com/simple/
#RUN /root/anaconda3/bin/pip install web.py==0.40.dev0
RUN /root/anaconda3/bin/pip install web.py==0.61
#RUN /root/anaconda3/bin/conda install -y pytorch-cpu torchvision-cpu -c pytorch
RUN /root/anaconda3/bin/pip install torch torchvision -i https://pypi.doubanio.com/simple/
