...
RUN /root/anaconda3/bin/pip install easydict opencv-contrib-python==3.4.2.17 Cython h5py pandas requests bs4 matplotlib lxml -U pillow keras==2.2.4 tensorflow==1.13.1 -i https://pypi.doubanio.com/simple/
